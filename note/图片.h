...
<Image source={icon} />
本特性从0.14开始生效。请注意：新的资源系统依靠修改打包脚本来实现，react-native init创建的新工程已经包含了这些修改：Xcode和Gradle。如果你的工程是在0.13或者更早版本创建的，你可能需要自行添加对应的代码来支持新的图片资源系统。请参考文档升级版本文档中的升级操作说明。

#pragma mark - 使用混合App的图片资源
